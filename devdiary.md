...
Test for API endpoint currently failing because apparently google cloud sql tries to establish a connection during testing:

```
=================================== FAILURES ===================================
_______________________________ test_post_to_db ________________________________
mocker = <pytest_mock.plugin.MockerFixture object at 0x7f8641945e50>
...
E       AssertionError: assert 0 == ((1 + 11) - 2)
E        +  where 0 = <Mock name='MockPool().execute' id='140214603117856'>.call_count
E        +    where <Mock name='MockPool().execute' id='140214603117856'> = <Mock name='MockPool()' id='140214603117760'>.execute
E        +      where <Mock name='MockPool()' id='140214603117760'> = <Mock name='MockPool' id='140214603117616'>.return_value
E        +        where <Mock name='MockPool' id='140214603117616'> = <Mock name='MockPool.connect()' id='140214603117472'>.__enter__
E        +          where <Mock name='MockPool.connect()' id='140214603117472'> = <Mock name='MockPool.connect' id='140214603117712'>.return_value
E        +            where <Mock name='MockPool.connect' id='140214603117712'> = <Mock name='MockPool' id='140214603117616'>.connect
E        +  and   11 = len({'company_count': '5533', 'educational_trainings': '7238', 'educational_trainings_and_regular_apprenticeships': '4298', 'inhouse_trainings': '899', ...})
cloud_functions/database_endpoint/tests/test_endpoint.py:70: AssertionError
------------------------------ Captured log call -------------------------------
...
=============================== warnings summary ===============================
cloud_functions/database_endpoint/tests/test_endpoint.py::test_post_to_db
  /home/runner/work/AusbildungMining/AusbildungMining/cloud_functions/database_endpoint/database_endpoint.py:106: UserWarning: Connection to database failed. Your default credentials were not found. To set up Application Default Credentials, see https://cloud.google.com/docs/authentication/external/set-up-adc for more information.
    warnings.warn(f"Connection to database failed. {e}")
-- Docs: https://docs.pytest.org/en/stable/how-to/capture-warnings.html
=========================== short test summary info ============================
FAILED cloud_functions/database_endpoint/tests/test_endpoint.py::test_post_to_db - AssertionError: assert 0 == ((1 + 11) - 2)
 +  where 0 = <Mock name='MockPool().execute' id='140214603117856'>.call_count
 +    where <Mock name='MockPool().execute' id='140214603117856'> = <Mock name='MockPool()' id='140214603117760'>.execute
 +      where <Mock name='MockPool()' id='140214603117760'> = <Mock name='MockPool' id='140214603117616'>.return_value
 +        where <Mock name='MockPool' id='140214603117616'> = <Mock name='MockPool.connect()' id='140214603117472'>.__enter__
 +          where <Mock name='MockPool.connect()' id='140214603117472'> = <Mock name='MockPool.connect' id='140214603117712'>.return_value
 +            where <Mock name='MockPool.connect' id='140214603117712'> = <Mock name='MockPool' id='140214603117616'>.connect
 +  and   11 = len({'company_count': '5533', 'educational_trainings': '7238', 'educational_trainings_and_regular_apprenticeships': '4298', 'inhouse_trainings': '899', ...})
==================== 1 failed, 2 passed, 1 warning in 0.61s ====================
